...
function Footer() {
    ...
    const Subscribe = async (e) => {
        email === "" ? toast.error("please write an email") : (
            await axios.post(`${process.env.REACT_APP_URL}contact/subscribe/`, {
                email: email
            })
                .then(res => {
                    ...
                    <div className={classes.row}>
                        ...
                        <div className={classes.Right}>
                            <input type="email" placeholder={
                                translate("Вводите свой емаил адресс", "Email adresingizni kiriting", 'Enter your email address')
                    ...
                    <div className={classes.FooterBottomRow}>
                        <div className={classes.FooterLeft}>
                            ...
                            <div className={classes.socials}>
                                ...
                                <li>
                                    <a href="vimeo.com"><i className="fa-brands fa-vimeo-v"></i></a>
                                </li>
                            </div>
                        </div>
                        {loading ? < Loading2 /> : <div className={classes.FooterRight}>
                            <ul>
                                <h4>
                                    {
                            ...
                            <ul>
                                <h4>
                                    {
                                        translate("Обслуживание клиентов", "Mijozlarga xizmat", "Customer Care")
                                    }
                                </h4>
                                <li><Link to="/">
                                    {
