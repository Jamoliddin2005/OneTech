...
export default function Navbar({
  ...
  const [language, setLanguage] = useState(["ru", "en", "uz"]);
          ...
          <div className={classes.Row}>
            ...
            <div className={classes.center}>
              <ul>
                ...
                <li>
                  <a
                    href="https://www.instagram.com/ibragimovxusan_/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
          ...
          <div className={classes.Navbar_center_right}>
            ...
            <div className={classes.Wishlist}>
              ...
              <Link to={"/wishlist"} className={classes.Wishlist_right}>
                <h6>{translate("Избранные", "Tanlanganlar", "Wishlist")}</h6>
              </Link>
            </div>
            <Link to={"/cart"}>
        ...
        <div className="container">
          <div className={classes.Navbar_Bottom_row}>
            ...
            <div onClick={heightHandler} className={classes.menu}>
              <span>{translate("Меню", "Menyu", "Menu")}</span>
              <i className="fa-solid fa-bars"></i>
            </div>
                    ...
                    >
                      <Link to={"/"} className={classes.account}>
                        <div className={classes.account}>
                          ...
                          <p>{translate("Вход", "Kirish", "Log in")}</p>
                        </div>
                      </Link>
                    </div>
                  </li>
