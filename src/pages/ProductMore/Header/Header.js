...
const Header = ({ product, category1, cartNumbers }) => {
        ...
        <div className={classes.product}>
            ...
            {product ? (
              <>
                ...
                <div className={classes.singleImg}>
                  <img
                    src={product.product_images[activeImg].get_image_url}
                    alt="img"
                  />
                </div>
              </>
          ...
          <div className={classes.right}>
            <div className={classes.right_items}>
              ...
              <p className={classes.product_text}>{product.consists}</p>
              <form
                className={classes.form}
                onSubmit={(e) => e.preventDefault()}
              >
                <span className={classes.oldPrice}>
                  {Curreny(product.price)} UZS
                </span>
                <p className={classes.productPrice}>
                  {Curreny(product.get_discounted_price)}{" "}
                  <span className={classes.UZS}>UZS</span>
                </p>
